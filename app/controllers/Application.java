...
public class Application {
    ...
    public static final String ACCOUNT_SID = Play.application().configuration().getString("account.sid");
    public static final String AUTH_TOKEN = Play.application().configuration().getString("auth.token");
        ...
        for(models.Register rgstr : numbers) {
        	...
        	if(null == ignore || !rgstr.phoneNumber.equals(ignore))
        	{
	        	try {
		            ...
		            params.add(new BasicNameValuePair("From", Play.application().configuration().getString("sms.default")));
